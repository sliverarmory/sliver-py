...
class Request(Message):
    ...
    def ClearField(self, field_name: Literal["Async", b"Async", "BeaconID", b"BeaconID", "SessionID", b"SessionID", "Timeout", b"Timeout"]) -> None: ...
...
class Response(Message):
    ...
    def ClearField(self, field_name: Literal["Async", b"Async", "BeaconID", b"BeaconID", "Err", b"Err", "TaskID", b"TaskID"]) -> None: ...
...
class Process(Message):
    ...
    def ClearField(self, field_name: Literal["Architecture", b"Architecture", "CmdLine", b"CmdLine", "Executable", b"Executable", "Owner", b"Owner", "Pid", b"Pid", "Ppid", b"Ppid", "SessionID", b"SessionID"]) -> None: ...
